...
export function getTeacherListPage(current,pageSize,teacherQuery) {
    ...
    return request({
        ...
        url: `/edu/teacherService/selectTPageParam/${current}/${pageSize}`,
        method: 'post',
...
export function insertT(teacher){
    return request({
        url: `/edu/teacherService/insertT`,
        method: 'post',
        data: teacher
    })
}
...
export function queryTById(id){
    return request({
        url: `/edu/teacherService/queryTById?teacherId=${id}`,
        method: 'get'
    })
}
...
export function updateTearcher(teacher){
    return request({
        url: `/edu/teacherService/updateTearcher`,
        method: 'post',
        data: teacher
    })
}
...
export function getListTeacher() {
    return request({
        url: `/edu/teacherService/findAllTeach`,
        method: 'get'
        })
}
