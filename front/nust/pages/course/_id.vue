    ...
    <section class="container">
      ...
      <div>
        <article class="c-v-pic-wrap" style="height: 357px;">
          <section height="300px" class="p-h-video-box" id="videoPlay">
                        ...
                        <ul>
                          ...
                          <li class="lh-menu-stair" v-for="chapter in chapterVideoList" :key="chapter.id">
                            ...
                            <ol class="lh-menu-ol" style="display: block;">
                              <li class="lh-menu-second ml30" v-for="video in chapter.videoVOList" :key="video.id">
...
export default {
  data(){
   ...
   asyncData({ params, error }) {
     return courseApi.queryCourseInfo(params.id)
        .then(response => {
          return {
            courseWebVo: response.data.data.courseDetails,
